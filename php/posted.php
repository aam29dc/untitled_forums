...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    if(!isset($_GET['replyid'])) $replyid = NULL;
...
echo '<script src="'.abs_php_include($x).'js/waitdirect.js"></script><script>waitdirect(2000,"'.abs_php_include($x).'index.php?thread='.$_SESSION['threadid'].'");</script>';
?>
</body></html>